...
_Generated by `python3 scripts/run_perf_serial.py full` on 2026-03-10 02:05:46 UTC. Lowmem message-delta blocks were refreshed on 2026-03-11 from direct lowmem harness runs because an unrelated `file_throughput_test` regression currently blocks a clean full auto-regeneration._
