...
- `test_create_event_synchronous_contract_valid_only` — explicit §6.4 contract
- `test_create_event_synchronous_contract_blocked_returns_err_with_event_id` — error shape contract
