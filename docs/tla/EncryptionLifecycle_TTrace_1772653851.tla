---- MODULE EncryptionLifecycle_TTrace_1772653851 ----
...
_inv ==
    ~(
        ...
        /\
        localKey = ([p1 |-> [k1 |-> TRUE, k2 |-> FALSE], p2 |-> [k1 |-> TRUE, k2 |-> FALSE]])
    )
----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("EncryptionLifecycle_TTrace_1772653851.json", _TETrace)
...
\*
\*trace == IODeserialize("EncryptionLifecycle_TTrace_1772653851.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([materializedViaUnwrap |-> [p1 |-> [k1 |-> FALSE, k2 |-> FALSE], p2 |-> [k1 |-> FALSE, k2 |-> FALSE]],peerRemoved |-> [p1 |-> FALSE, p2 |-> FALSE],encryptedContent |-> [p1 |-> [c1 |-> "none"], p2 |-> [c1 |-> "none"]],decryptable |-> [p1 |-> [c1 |-> FALSE], p2 |-> [c1 |-> FALSE]],wrappedTo |-> [p1 |-> [k1 |-> {}, k2 |-> {}], p2 |-> [k1 |-> {}, k2 |-> {}]],localKey |-> [p1 |-> [k1 |-> FALSE, k2 |-> FALSE], p2 |-> [k1 |-> TRUE, k2 |-> FALSE]]]),
    ([materializedViaUnwrap |-> [p1 |-> [k1 |-> FALSE, k2 |-> FALSE], p2 |-> [k1 |-> FALSE, k2 |-> FALSE]],peerRemoved |-> [p1 |-> FALSE, p2 |-> FALSE],encryptedContent |-> [p1 |-> [c1 |-> "k1"], p2 |-> [c1 |-> "none"]],decryptable |-> [p1 |-> [c1 |-> FALSE], p2 |-> [c1 |-> FALSE]],wrappedTo |-> [p1 |-> [k1 |-> {}, k2 |-> {}], p2 |-> [k1 |-> {}, k2 |-> {}]],localKey |-> [p1 |-> [k1 |-> FALSE, k2 |-> FALSE], p2 |-> [k1 |-> TRUE, k2 |-> FALSE]]]),
    ([materializedViaUnwrap |-> [p1 |-> [k1 |-> FALSE, k2 |-> FALSE], p2 |-> [k1 |-> FALSE, k2 |-> FALSE]],peerRemoved |-> [p1 |-> FALSE, p2 |-> FALSE],encryptedContent |-> [p1 |-> [c1 |-> "k1"], p2 |-> [c1 |-> "none"]],decryptable |-> [p1 |-> [c1 |-> FALSE], p2 |-> [c1 |-> FALSE]],wrappedTo |-> [p1 |-> [k1 |-> {}, k2 |-> {}], p2 |-> [k1 |-> {}, k2 |-> {}]],localKey |-> [p1 |-> [k1 |-> TRUE, k2 |-> FALSE], p2 |-> [k1 |-> TRUE, k2 |-> FALSE]]])
    >>
----
...
---- CONFIG EncryptionLifecycle_TTrace_1772653851 ----
CONSTANTS
    Peers = { "p1" , "p2" }
    Keys = { "k1" , "k2" }
    Contents = { "c1" }
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Mar 04 11:50:52 PST 2026