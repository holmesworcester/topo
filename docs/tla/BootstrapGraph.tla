...
\*
\* Bootstrap sequence:
\*   1. invite_accepted (local, sets trust anchor)
\*   2. network (gated by trust anchor)
...
\*   9. invite_accepted_bob (local, sets trust anchor for Bob's connection)
...
EVENTS == {
    Net, InviteAcceptedAlice, UserInviteBoot, UserAlice, AdminBootAlice,
