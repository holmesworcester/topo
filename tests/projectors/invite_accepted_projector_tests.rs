...
mod tests {
    ...
    fn test_invite_accepted_rejects_missing_local_link_workspace_binding() {
        ...
        let result =
            build_projector_context(&queries, PEER, "event_ia_missing_link", &parsed).unwrap();
    ...
    fn test_invite_accepted_rejects_local_link_workspace_mismatch() {
        ...
        let result = build_projector_context(&queries, PEER, "event_ia_mismatch", &parsed).unwrap();
        assert_context_reject_contains(
            &result,
