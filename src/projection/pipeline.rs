...
mod tests {
    ...
    use crate::events::{
        self, EncryptedEvent, FileSliceEvent, MessageAttachmentEvent, MessageDeletionEvent,
        MessageEvent, ParsedEvent, PeerKeyEvent, ReactionEvent, SecretKeyEvent, SignedMemoEvent,
