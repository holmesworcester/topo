...
/// a peer_shared signer is present, we additionally load the
/// `authority_event_id` dep blob and parse it as an AdminEvent; the
/// decide fn uses this to compute `authority_matches_signer`.
