...
pub struct ContextSnapshot {
    ...
    /// For invite events signed by peer_shared: whether the signer currently
    /// resolves to an admin identity under this tenant view.
    pub signer_is_admin: Option<bool>,
