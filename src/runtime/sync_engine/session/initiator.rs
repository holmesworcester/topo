...
use crate::sync::session::receive::try_acquire_peer_session_ingest_guard;
    ...
    R: StreamRecv + Send + 'static,
{
    ...
    let maybe_peer_session_ingest_guard = try_acquire_peer_session_ingest_guard(db_path, peer_id)?;
    let data_plane = run_range_data_plane(
        &store,
        data_send,
        data_recv,
        maybe_peer_session_ingest_guard,
        db_path,
        recorded_by,
        &ws_id,
        peer_id,
