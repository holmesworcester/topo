...
pub use peering_boundary::{
    ...
    dial_session_provider, node_trusts_peer, open_inbound_session, open_outbound_dependency_session,
    open_outbound_session, outbound_session_provider_for_connection, read_intro_offer_frame,
