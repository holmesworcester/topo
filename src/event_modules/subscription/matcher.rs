...
fn parsed_event_type_name(parsed: &ParsedEvent) -> &'static str {
    match parsed {
        ...
        ParsedEvent::UserBoot(_) | ParsedEvent::UserOngoing(_) => "user",
        ParsedEvent::UserInviteBoot(_) | ParsedEvent::UserInviteOngoing(_) => "user_invite",
        ParsedEvent::DeviceInviteFirst(_) | ParsedEvent::DeviceInviteOngoing(_) => "device_invite",
        ParsedEvent::PeerSharedFirst(_) | ParsedEvent::PeerSharedOngoing(_) => "peer_shared",
        ParsedEvent::AdminBoot(_) | ParsedEvent::AdminOngoing(_) => "admin",
