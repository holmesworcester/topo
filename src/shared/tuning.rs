...
// -- Ingest pipeline --
pub fn drain_batch_size() -> usize { if low_mem_mode() { 50 } else { 100 } }
pub fn write_batch_cap() -> usize { if low_mem_mode() { 500 } else { 1000 } }

// -- Peering --
pub fn shared_ingest_cap() -> usize { if low_mem_mode() { 1000 } else { 10000 } }

// -- Sync sessions --
pub fn session_ingest_cap() -> usize { if low_mem_mode() { 1000 } else { 5000 } }

// -- Transport --
pub fn max_recv_buffer() -> usize { if low_mem_mode() { 512 * 1024 } else { 2 * 1024 * 1024 } }
