...
See [Motivations](#Motivation) for more.
...
This PoC exists to prove the practicality of a principled approach to local-first/p2p/e2ee messaging adequate for building complex, user-facing applications. 
